const apikey="c1906a7edfdf7e03a2052ca7b28c49af";
...
//   return movieCard;
// }
// // Function to perform a search using the TMDB API
...
//         if (movies.length === 0) {
//           movieResultsContainer.textContent = 'No movies found.';
//         } else {
...
//         movieResultsContainer.textContent = 'An error occurred while fetching movie results.';
//       });
